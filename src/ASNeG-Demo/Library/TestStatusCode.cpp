...
namespace OpcUaServerApplicationDemo
{
	...
	bool
	TestStatusCode::shutdown(void)
	{
		Log(Debug, "TestStatusCode::shutdown");
		return true;
	}
	...
	TestStatusCode::getNamespaceInfo(void)
	{
		...
		{
			if (it->second == "http://ASNeG-Demo.de/TestStatusCode/") {
	...
	bool
	TestStatusCode::createValueMap(void)
	{
		OpcUaNodeId nodeId;
		OpcUaDataValue::SPtr dataValue;
	...
	void
	TestStatusCode::readValue(ApplicationReadContext* applicationReadContext)
	{
	    ValueMap::iterator it;
	...
	void
	TestStatusCode::readLoopTimeValue(ApplicationReadContext* applicationReadContext)
	{
	...
	void
	TestStatusCode::writeValue(ApplicationWriteContext* applicationWriteContext)
	{
	...
	void
	TestStatusCode::writeLoopTimeValue(ApplicationWriteContext* applicationWriteContext)
	{
	...
	void
	TestStatusCode::startTimerLoop(void)
	{
		// TimerInterval
